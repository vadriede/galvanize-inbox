const initialState = {
    messages: [
        ...
        { id: 2, subject: 'GDPR request counter update - averaging 2 per year!', isRead: false, isSelected: false, labels: [], isStarred: false },
        ...
        { id: 6, subject: 'What We Owe to Each Other', isRead: false, isSelected: false, labels: [], isStarred: false },
